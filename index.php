...
<body>
      ...
      <section id="banner">
            ...
            <div id="titre">LES PLUS TENDANCES</div>
            <div class="post">
      ...
      <section id="discover">
            ...
            <img src="./img/Groupe 13.png" id="product-img" alt="">
            <div id="offers-container">

                  <div id="offer">
                        <span id="offer-title">SERVICE <span>ADHERENT</span></span>
                        <ul>
                              <li>Participation a des events</li>
                              <li class="no">Organiser des events</li>
                              <li class="no">Percevoir des gains</li>
                  ...
                  <div id="offer">
                        ...
                        <ul>
                              <li class="no">Participation a des events</li>
                              <li>Organiser des events</li>
                              <li>Percevoir des gains</li>
